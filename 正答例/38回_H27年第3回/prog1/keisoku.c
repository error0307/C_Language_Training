...
int date_change( void )
{
    ...
    /* 最高計測日付更新 */
    if (strcmp(kojin_keisoku_tbl.max_date, kojin_keisoku_tbl.soku_date) == 0 
             && kojin_keisoku_tbl.max_data == kojin_keisoku_tbl.soku_data[0]) {
        strcpy(kojin_keisoku_tbl.max_date, keisoku_date);
    }    
